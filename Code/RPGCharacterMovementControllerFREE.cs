...
// This is not Mine this came from RPG Character Animation pack
//uploaded by Rofar34
//for commercial use
//website: https://www.explosive.ws/products/warrior-pack-bundle-2
//some code has been modified because this does not work
//Lewis Brown Changed: AcquiringGround(),  MaintainingGround()
//this switches between animations as well
// may replace currently the character doesnt collid with the floor
//Used to test collision/character movement
	...
	public class RPGCharacterMovementControllerFREE : SuperStateMachine{
		...
		*/
		...
		private bool AcquiringGround(){
			return superCharacterController.currentGround.IsGrounded(false, 0.01f);//original is 0.01f
		}

		public bool MaintainingGround(){
			return superCharacterController.currentGround.IsGrounded(true, 0.5f); //original is 0.5f
		}
